...
// 🔹 Animation variants for glow effect on social icons
const glowVariants = {
    ...
    tap: { scale: 0.95, y: 0, transition: { duration: 0.08 } }, // fixed typo 'transtion' → 'transition'
}
            ...
            <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
                    <div className="w-full lg:pr-24 mx-auto max-w-3xl">
                        ...
                        <motion.h1
                            className="
                text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold text-transparent bg-clip-text
              ...
              "
                        ...
                        >
                            Hello, I'm <br />
                            <span className="text-white font-bold text-5xl sm:text-6xl md:text-7xl lg:text-7xl lg:whitespace-nowrap">
                                Shubham Kumar Gupta
                            </span>
                        </motion.h1>
