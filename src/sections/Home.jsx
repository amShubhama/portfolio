...
const glowVarients = {
    ...
    tap: { scale: 0.95, y: 0, transtion: { duration: 0.08 } }
}
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
            ...
            else if (deleting && subIndex > 0) setSubindex(p => p - 1);
            else {
                setDeleting(false);
            ...
            >
                <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
                    <div className='w-full lg:pr-24 mx-auto max-w-3xl'>
                        ...
                        <motion.h1
                            className='text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold text-transparent bg-clip-text 
                        ...
                        >
                            Hello, I'm <br />
                            <span
                                className='text-white font-bold text-5xl sm:text-6xl md:text-7xl lg:text-7xl lg:whitespace-nowrap'
                            >
                                Shubham Kumar Gupta
                            </span>
                        </motion.h1>
                        ...
                        <motion.div
                            className='mt-10 flex flex-wrap itmes-center justify-center lg:justify-start gap-6'
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
